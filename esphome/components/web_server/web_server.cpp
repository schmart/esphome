...
void WebServer::set_js_enable_cors(const bool enable_cors) { this->js_enable_cors_ = enable_cors; }
void WebServer::set_js_cors_header(const char *cors_header) { this->js_cors_header_ = cors_header; }
